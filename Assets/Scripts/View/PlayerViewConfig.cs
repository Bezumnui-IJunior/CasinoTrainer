...
namespace View
{
    ...
    public class PlayerViewConfig : ScriptableObject, IPlayerViewConfig
    {
        ...
        public float PayerFirstCardOffsetX => _payerFirstCardOffsetXFactor * _cardViewConfig.CardWidth;
        public float CardOffsetX => _cardOffsetXFactor * _cardViewConfig.CardWidth;
    }
}